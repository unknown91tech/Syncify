...
const ParameterDisplayEthBlockNumber: React.FC = () => {
      ...
      <CardContent className="p-0">
        <Table>
          ...
          <TableBody>
            ...
            <TableRow className="hover:bg-muted/50">
              <TableCell className="font-medium">params</TableCell>
              <TableCell>
                <Badge variant="outline" className="font-mono text-xs bg-purple-50 text-purple-700 border-purple-200">
                  array
                </Badge>
              </TableCell>
              <TableCell className="text-sm text-muted-foreground">Empty array for this method</TableCell>
            </TableRow>
            <TableRow className="hover:bg-muted/50">
              ...
              <TableCell className="text-sm text-muted-foreground">Blockchain platform (e.g., "Ethereum")</TableCell>
            </TableRow>
            <TableRow className="hover:bg-muted/50">
              ...
              <TableCell className="text-sm text-muted-foreground">Network name (e.g., "Mainnet", "Sepolia", "Holesky")</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </CardContent>
...
export default ParameterDisplayEthBlockNumber;